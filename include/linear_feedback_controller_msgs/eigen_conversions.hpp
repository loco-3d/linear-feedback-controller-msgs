...
inline void sensorMsgToEigen(
	const linear_feedback_controller_msgs::msg::Sensor& m, linear_feedback_controller_msgs::Eigen::Sensor& e) {
...
inline void controlMsgToEigen(
	const linear_feedback_controller_msgs::msg::Control& m, linear_feedback_controller_msgs::Eigen::Control& e) {
